...
.PHONY: help image build check test fetch updates updates-write shell clean
...
help:
	...
	@echo "make test           confirm the update writer preserves catalog formatting"
...
test: image
	$(RUN) python tests/test_apply_updates.py
